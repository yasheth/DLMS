...
public class MCGServer implements LibraryInterface {
	...
	private static void activateServer() throws AlreadyBoundException, IOException {
		...
		Remote obj = UnicastRemoteObject.exportObject(mcgserver, 4444);
		...
		System.out.println(mcgserver.addItem("Server", "MCG4444", "mcg", 10));
	...
	private void initiateUDPSocket() throws NotBoundException {
		...
		try {
			...
			byte[] buffer = new byte[100000];
			System.out.println("McGill UDP Socket 4444 Initiated for inter library communication");
			while (true) {
